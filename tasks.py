...
class GameTasks():
    def code_task(self, agent, game):
        return Task(
            ...
            """),
            agent=agent,
            expected_output="The full python code for the game"
        )
    ...
    def review_task(self, agent, game):
        return Task(
            ...
            """),
            agent=agent,
            expected_output="The full python code for the game with all issues fixed"
        )
    ...
    def evaluate_task(self, agent, game):
        return Task(
            ...
            """),
            agent=agent,
            expected_output="The final validated python code for the game"
        )